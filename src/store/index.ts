...
import receivedTransfersReducer from "./slices/receivedTransfers.slice";
import workspacesReducer from "./slices/workspaces.slice";
...
const rootReducer = combineReducers({
  ...
  login: loginReducer,
  auth: authReducer,
  receivedTransfers: receivedTransfersReducer,
